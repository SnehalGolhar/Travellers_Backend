...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends
        ...
        public void configure(HttpSecurity http) throws Exception {
            http.authorizeRequests()
                    ...
                    .antMatchers("/get-attractions/*").authenticated()
                    .antMatchers("/get-itinerary/*").authenticated()/*
    ...
    protected static class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
        ...
        public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
            clients.jdbc(dataSource).withClient(CLIENT_ID).secret(CLIENT_SECRET)
        	// clients.jdbc(dataSource).passwordEncoder(passwordEncoder)
				.authorizedGrantTypes("password", "refresh_token")
				.authorities("USER")
				.scopes("read", "write")
				.resourceIds(RESOURCE_ID).accessTokenValiditySeconds(3600)
